...
class A2C(object):
    ...
    # Superparameters
        ...
        self.actor = Actor(self.sess, n_features=s_dim, n_actions=a_dim, lr=LR_A)
        self.critic = Critic(self.sess, n_features=s_dim, lr=LR_C)     
    ...
    def critic_learn(self, s, r, s_):
        return self.critic.learn(s, r, s_)
